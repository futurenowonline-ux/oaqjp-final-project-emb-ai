...
This module contains the Flask web server that provides emotion detection
functionality using the Watson NLP emotion detection service.
"""
...
def sent_detector():
    ...
    # Handle invalid input (when dominant_emotion is None)
